...
//         this.getMousePosition(e);
//         const target = Math.floor(this.view.ViewState.mouse_x / this.view.ViewState.CellSize) * 10 + Math.floor(this.view.ViewState.mouse_y / this.view.ViewState.CellSize);
...
//                 return true;
//             }
//             const canm = Rule.getCanMovePanelX(this.gameState.hover_piece!, this.gameState.thisMap);
...
//         let endTime;
//         // 終盤になったら長考してみる。
//         const count = this.getNodeCount(this.gameState.thisMap) / 2;
//         let plus = 0;
//         switch (level) {
//             case 1:
//                 if (count <= 7) {
...
//         const hand = Aijs.thinkAI(this.gameState.thisMap, this.gameState.turn_player, level + plus + 1, undefined, undefined, undefined)[0];
...
//         // クリア
//         for (const num in this.gameState.thisMap) {
